...
public class JwtVerifierFilter extends OncePerRequestFilter {
	...
	public JwtVerifierFilter(SecretKey secretKey, JwtConfig jwtConfig) {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if(token.equals(null) || !token.startsWith(jwtConfig.getTokenPrefix())) {
		...
		try {
			...
			Authentication authentication = new UsernamePasswordAuthenticationToken(claims.getBody().getSubject(), null, authorities);
